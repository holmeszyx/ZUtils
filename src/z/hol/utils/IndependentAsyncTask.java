 ...
 * @param <Result>
 */
public abstract class IndependentAsyncTask<Params, Progress, Result> {
     ...
     *         {@link IndependentAsyncTask.Status#RUNNING} or {@link IndependentAsyncTask.Status#FINISHED}.
     */
    public final IndependentAsyncTask<Params, Progress, Result> execute(Params... params) {
     ...
     *         {@link IndependentAsyncTask.Status#RUNNING} or {@link IndependentAsyncTask.Status#FINISHED}.
     */
    public final IndependentAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec,
            Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
        final IndependentAsyncTask mTask;
        final Data[] mData;

        AsyncTaskResult(IndependentAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
