...
public class DiskLruCache {
     ...
     * @return
     */
    public static String createUrlencodeFilePaht(File cacheDir, String key){
        try {
    ...
    public static String encodeKey(String key){
    	String encoded = null;
    	encoded = mEncodedKeyCache.get(key);
    	if (encoded == null){
    		encoded = DigestUtils.md5Hex(key);
    		mEncodedKeyCache.put(key, encoded);
    	}
    	return encoded;
    }
